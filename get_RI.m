%% This script calculates reliability indices of STRFs for (sorted) spike data with a given trigger file. Assumes a standard kilosort output in the sorted data directory.
